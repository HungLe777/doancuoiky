...
<div class = "my-5 px-4">
    ...
    <p class = "text-center mt-3">
        pppppdppddfdfsfgsfvhhfvhskjdcnksdcn <br> dfjhsdhfdsfjsdfhsdhfkj
        ...
        <div class="row ">
            <div class="col-lg-6 col-md-6 mb-5 px-4">
                <div class="bg-white rounded shadow p-4">
                    ...
                    <br>
                    <h5>Địa chỉ</h5>
                    <a href="<?php echo $contact_r['DiaChi'] ?>" target="_black" class="d-inline-block text-decoration-none text-dark mb-2">
                        <i class="bi bi-geo-alt-fill"></i> <?php echo $contact_r['DiaChi'] ?>
                    </a>  
                ...
                <div class="bg-white rounded shadow p-4">
                    <form method="POST">
                        ...
                        <div class="mt-3">
                            ...
                            <input name="Ten" required type="text" class="form-control shadow-none">                      
                        </div>
                        <div class="mt-3">
                        ...
                        <div class="mt-3">
                            ...
                            <textarea name="TinNhan" required class="form-control shadow-none" rows="5" style="resize: none;"></textarea>                     
                        </div>
                        <button type="submit" name="Gui" requiredclass="btn text-white custom-bg mt-3 shadow none">Gửi</button>
                    </form>
                </div>           
            </div>
...
if(isset($_POST['Gui'])) 
{
    ...
    $q = "INSERT INTO user_queries (Ten,email,subject,TinNhan) VALUES (?,?,?,?)";
    $values = [$frm_data['Ten'],$frm_data['Email'],$frm_data['subject'],$frm_data['TinNhan']];
    $res = insert($q,$values,'ssss');
    if($res==1){
        alert('success','maid send');
    }
    else{
