<?php 
  ...
  if(isset($_POST['add_room'])) 
  {
    ...
    $facilities =filteration(json_decode($_POST['facilities']));
      ...
      $q1 = "INSERT INTO rooms (Ten,area,price,quantity,adult,children,description) VALUES (?,?,?,?,?,?,?)";
      $values = [$frm_data['Ten'],$frm_data['area'],$frm_data['price'],$frm_data['quantity'],$frm_data['adult'],$frm_data['children'],$frm_data['description']];
        ...
        $data.="
          <tr class='align-middle'>
            ...
            <td>
              ...
              <button type='button' onclick=\"room_images($row[id],'$row[Ten]')\" class='btn btn-info shadow-none btn-sm' data-bs-toggle='modal' data-bs-target='#room-images'>
  ...
  if(isset($_POST['edit_room'])) 
  {
    ...
    $facilities =filteration(json_decode($_POST['facilities']));
      ...
      $q1= "UPDATE rooms SET Ten=?, area=?, price=?, quantity=?, adult=?, children=?, description=? WHERE id=?";
      $values = [$frm_data['Ten'],$frm_data['area'],$frm_data['price'],$frm_data['quantity'],$frm_data['adult'],$frm_data['children'],$frm_data['description'],$frm_data['room_id']];
  ...
  if(isset($_POST['get_room_images'])) 
  {
    ...
    while($row = mysqli_fetch_assoc($res))
      {
        if($row['thumb']==1){
          $thumb_btn = "<i class='bi bi-check-lg text-light bg-success px-2 py-1 rounded fw-5'></i>";      
        }
        else{
