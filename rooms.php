...
<head>
    ...
    <title><?php echo $settings_r['site_title'] ?> - ROME  </title>
</head>
<body class ="bg-light">
...
<div class = "my-5 px-4">
    <h2 class ="fw-bold h-font text-center "> Phong</h2>
            ...
            <nav class="navbar navbar-expand-lg navbar-light bg-light rounded shadow">
                <div class="container-fluid flex-lg-column align-items-stretch">
                    ...
                    <div class="collapse navbar-collapse flex-column align-items-stretch mt-2" id="filterDropdown">
                        ...
                        <div class="border bg-light p-3 rounded mb-3">
                            <h5 class="mb-3" style="font-size: 18px">faci</h5>
                            <div class="mt-2">
                            <input type="checkbox" id="f1" class="form-check-input shadow-none me-1">
                            <label class="form-check-label" for ="f1">Faci one</label>
                            </div>
                            <div class="mt-2">
                            <input type="checkbox" id="f2" class="form-check-input shadow-none me-1">
                            <label class="form-check-label" for ="f2">Faci 2</label>
                            </div>
                            <div class="mt-2">
                            <input type="checkbox" id="f3" class="form-check-input shadow-none me-1">
                            <label class="form-check-label" for ="f3">Faci 3</label>
                            </div>
                        ...
                        <div class="border bg-light p-3 rounded mb-3">
                            ...
                            <div class="d-flex">
                                ...
                                <input type="mumber" class="form-control shadow-none ">
                                </div>
                                <div >
                    ...
                    <div class="card mb-4 border-0 shadow-none">
                        <div class="row g-0 p-3 align-items-center">
                            ...
                            <div class="col-md-5 px-lg-3 px-md-3 px-0">
                                <h5 class ="mb-3"> $room_data[Ten]</h5>
                            ...
                            <a href="room_details.php?id=$room_data[id]" class="btn btn-sm w-100 btn-outline-dark shadow-none"> More detail</a>
                            </div>
                        </div>
                    </div>
                data;
